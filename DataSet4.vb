...
Public Class DataSet4
    ...
    Public Class HistoryDataTable
        ...
        Public Overloads Function AddHistoryRow(ByVal Cost As Integer, ByVal Order As String, ByVal OrderQ As Integer, ByVal Price As Integer, ByVal TableNo As String, ByVal OrderDate As Date) As HistoryRow
            Dim rowHistoryRow As HistoryRow = CType(Me.NewRow,HistoryRow)
            rowHistoryRow.ItemArray = New Object() {Cost, Nothing, Order, OrderQ, Price, TableNo, OrderDate}
